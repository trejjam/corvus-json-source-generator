...
public readonly partial struct FlimFlam
{
    ...
    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
    {
        ...
        if (level > ValidationLevel.Basic)
        {
            ...
            result = result.PushSchemaLocation("https://corvus-oss.org/json-schema/2020-12/schema.json");
        }
            ...
            while (arrayEnumerator.MoveNext())
            {
                ...
                switch (length)
                {
                    case 0:
                        ...
                        result = arrayEnumerator.Current.As<SourceGenTest2.Model.FlimFlam.PrefixItems0Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
                    ...
                    case 3:
                        if (level > ValidationLevel.Basic)
                        {
                            result = result.PushValidationLocationReducedPathModifier(new("#/prefixItems/3"));
                        }

                        result = arrayEnumerator.Current.As<SourceGenTest2.Model.FlimFlam.PrefixItems3Entity>().Validate(result, level);
                        if (level == ValidationLevel.Flag && !result.IsValid)
                        {
                            return result;
                        }
